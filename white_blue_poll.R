...
# part II: What if all polls are combined?
N=n1+n2+n3+n4+n5+n6
...
calculate_support_and_SE(N,Rate_1A,Rate_1B,Rate_2A,Rate_2B)


# part III: What if 6 polls are separated into 12 smaller polls
calculate_support_and_SE(n1/2,rate_1_1A,rate_1_1B,rate_1_2A,rate_1_2B)
